...
num_1 = ["Ош","Бишкек","Талас","Ыссык-кол","Нарын","Жалал-абад","Баткен", "Honda", "Toyota","Lexus","Bugatty","Lamborghini","Runaway","Royalty","Impossible"]
# print(num_1[2:7])


"""ВТОРОЕ ЗАДАНИЕ"""

num_2 = [1,2,3,4,5,6,7,8,9,0,]
num_2.reverse()
# print(num_2)
...
num_2 = [1,2,3,4,5,6,7,8,9,0,]
# print(sum(num_2) / len(num_2))

"""СЕДЬМОЕ ЗАДАНИЕ"""

num_3 = ["Creepin","Star-boy","Dynasty","8-letters","Impossible","Gata only","MIA","Telescope","Attention","Unforgettable"]

num_3[4],num_3[8] = num_3[8], num_3[4]
# print(num_3)
...
# print(text.count("s"))
# print(text.count("t"))
advert_text = text.replace("Advert", "ADVERT",).replace("advert", "ADVERT")
# print(advert_text)